...
public class TankDrive extends CommandBase 
{
  ...
  public void execute() 
  {
    ...
    // This can mean really sluggish behavior at small input. Limiting max caps max robot speed but leaves the
    ...
    // So joystick response is customizable in several locations. Do not use squared inputs if you apply a
    ...
    if (robot.isAutonomous()) return;
	  ...
	  {	  // normal tank with straight drive assist when sticks within 10% of each other and
        ...
        //driveBase.tankDriveLimited(leftY, rightY);		// Normal tank drive acceleration limited.
