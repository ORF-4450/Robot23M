...
public class TestAuto3 extends CommandBase {
	...
	public void initialize() {
		...
		Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
				...
				List.of(new Translation2d(startPose.getX() + 1, startPose.getY()),
		...
		// command = new AutoDriveTrajectory(driveBase,
		// RobotContainer.slalom1Trajectory, StopMotors.stop, Brakes.on);
