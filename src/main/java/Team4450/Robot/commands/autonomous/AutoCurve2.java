...
public class AutoCurve2 extends CommandBase
{
	 ...
	 * @param target Target angle to turn. If using angle, this is 0..180, - left, + right. If using heading
	 * this is the target heading 0..359. If using totalAngle, this is total degrees of rotation, - left, + right.
     ...
     * totalAngle: target is number of degrees of rotation to turn.
	 * 
	 ...
	 * and accurately.
	 */
	public AutoCurve2(DriveBase driveBase,
					 double power, 
					 double curve, 
					 double target, 
					 StopMotors stop, 
