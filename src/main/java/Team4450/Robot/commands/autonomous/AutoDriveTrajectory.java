...
public class AutoDriveTrajectory extends RamseteCommand
{
    ...
    AutoDriveTrajectory(DriveBase driveBase, Trajectory trajectory, StopMotors stop, Brakes brakes)
    {
        super(trajectory,
                ...
                // Following was required with 2021 wpilib, above for 2022. Suspect this may be due
                // to the built in drive inversion in wpilib robotdrive and the confusion it caused us.
