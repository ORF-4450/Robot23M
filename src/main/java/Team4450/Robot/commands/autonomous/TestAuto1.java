...
/**
 * This is an example autonomous command using 4450 written library of auto
 * driving support commands.
 */
public class TestAuto1 extends CommandBase {
	...
	public void initialize() {
		...
		command = new AutoDrive(driveBase, .50, SRXMagneticEncoderRelative.getTicksForDistance(3, DRIVE_WHEEL_DIAMETER),
				AutoDrive.StopMotors.stop, AutoDrive.Brakes.on, AutoDrive.Pid.on, AutoDrive.Heading.angle);
		...
		command = new AutoDrive(driveBase, .50, 10000, AutoDrive.StopMotors.stop, AutoDrive.Brakes.on, AutoDrive.Pid.on,
