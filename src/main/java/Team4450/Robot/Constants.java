...
{
	public static String		PROGRAM_NAME = "ORF23M-01.30.24-1";
	...
	// Default starting field position in meters & degrees for pose tracking. For full field lower left corner.
