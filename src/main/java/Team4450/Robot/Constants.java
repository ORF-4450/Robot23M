...
public final class Constants {
	public static String PROGRAM_NAME = "ORF23M-02.12.24-1";
	...
	// Default starting field position in meters & degrees for pose tracking. For
	// full field lower left corner.
	...
	// Robot will go faster than this, more like 3 mps but this value tones down
	// autonomous speed.
	...
	// Drive base characterization results. These values from 2021 as placeholders
	// until 202?
