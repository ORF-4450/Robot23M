...
public class TimedRobot extends IterativeRobotBase {
	...
	static class Callback implements Comparable<Callback> {
		 ...
		 *            The common starting point for all callback scheduling in seconds.
		 * @param periodSeconds
		 *            The period at which to run the callback in seconds.
		 * @param offsetSeconds
		 *            The offset from the common starting time in seconds.
		 */
	 ...
	 *            The period at which to run the callback in seconds.
	 * @param offsetSeconds
	 *            The offset from the common starting time in seconds. This is
	 *            useful for scheduling a callback in a different timeslot relative
	 *            to TimedRobot.
	 */
