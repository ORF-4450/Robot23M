...
public class LimeLight extends SubsystemBase {
	...
	/**
	 * Update the targeting information held in this class from the LimeLight via
	 * the network tables.
	 *
	...
	/**
	 * Convert X axis normalized screen space (-1 to +1 mapping to 0 to 320) to
	 * pixels.
	 *
	 * @param value
	 *            Normalized screen space value.
	...
	/**
	 * Convert Y axis normalized screen space (-1 to +1 mapping to 0 to 320) to
	 * pixels.
	 *
	 * @param value
	 *            Normalized screen space value.
	 ...
	 *
	 * @return The distance as a % of the total field view area that is occupied by
	 *         the target area.
	 */
	 ...
	 * Return a measure of the target distance.
	 *
	 * @return The distance as an offset from the Y cursor setpoint. Assumes the Y
	 *         cursor has been calibrated for the correct target distance. Will
	 *         return zero when at correct distance to target.
	 */
	 ...
	 *
	 * @return The offset in degrees. - target is left of center, + target is right
	 *         of center.
	 */
	 ...
	 *
	 * @return The offset in degrees. - target is below center, + target is above
	 *         center.
	 */
